...
const resourceInfo: Record<ResourceType, { bg: string; text: string; icon: string; label: string }> = {
  wood: { bg: 'bg-wood', text: 'text-white', icon: '🌲', label: 'Wood Forest' },
  brick: { bg: 'bg-brick', text: 'text-white', icon: '🧱', label: 'Brick Quarry' },
  sheep: { bg: 'bg-sheep', text: 'text-text-dark', icon: '🐑', label: 'Sheep Pasture' },
  wheat: { bg: 'bg-wheat', text: 'text-text-dark', icon: '🌾', label: 'Wheat Field' },
  ore: { bg: 'bg-ore', text: 'text-white', icon: '⛰️', label: 'Ore Mine' },
  desert: { bg: 'bg-desert', text: 'text-text-dark', icon: '🏜️', label: 'Desert' },
};
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center">
              ...
              {number !== null && !isRobber && (
                <div className="mt-2 bg-[#FDFCF0] rounded-full w-12 h-12 flex flex-col items-center justify-center shadow-md border border-[#D4D1C5]">
                  <span className={cn(
